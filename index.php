...
<html lang="en">
    <head>
        ...
        <!-- Topicon-->
        <link rel="icon" type="image/x-icon" href="assets/img/IMG7_914.JPG"/>
    ...
    <body id="top">
        ...
        <div class="wrapper col3">
            <div class="container">
                <img src="assests/img/welcome-3345143_1280.jpg" style="width:100%;">
            ...
            <div id="footer">
                ...
                <div class="box contactdetails">
                    ...
                    <ul>
                        ...
                        <li class="last"><a href="assests/Raul Mendy Resume.pdf">Resume</a></li>
                    </ul>
                    </div>
                </div>
                <br class="clear" />
        ...
        <div id="copyright">
            <p class="fl_left">Copyright &copy; 2014 - All Rights Reserved - os-templates</p>
